...
CREATE TABLE IF NOT EXISTS clients (id int NOT NULL AUTO_INCREMENT, prenom varchar(30) NOT NULL, nom varchar(30) NOT NULL, mail varchar(30) NOT NULL, adresse varchar(100) NOT NULL, PRIMARY KEY(id));
...
INSERT INTO clients (prenom,nom,mail,adresse) VALUES ("Mickael", "Kael", "mickael.kael@orange.fr", "25 rue des poiriers 75015 Paris");
INSERT INTO clients (prenom,nom,mail,adresse) VALUES ("Edgar", "Grospiron", "edgar.grospiron", "13 av des pommier 74000 Annecy");
INSERT INTO clients (prenom,nom,mail,adresse) VALUES ("Julie", "Gayet", "julie.gayet@gmail.com", "8 boulevard de l'Elysee 75001 Paris");
