...
/**
 * Classe de servlet principale. Le servlet contient un doGet pour l'affichage
 * de l'ensemble des clients d'un conseillé, une fois celui-ci identifié. Le
 * servlet contient un doPost pour l'ajout d'un nouveau client
 * 
