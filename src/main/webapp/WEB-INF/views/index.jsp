						...
						<fieldset>
							...
							<div class="form-group">
								<div class="input -group">
								  ...
								  <input id="Login" name="Login" type="text" placeholder="Login" class="form-control input-md" pattern=".{3,}">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
								<input id="Password" name="Password" type="password" placeholder="Password" class="form-control input-md" pattern=".{5,}">
								<small id="passwordHelp" class="form-text text-muted">Votre Password doit contenir au moins 5 caractères </small>
							  </div>
							</div>
							<!-- Button -->
